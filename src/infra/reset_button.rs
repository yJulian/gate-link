...
/// Samples `button` (active-low, e.g. the onboard BOOT button on most ESP32 devkits) and,
...
pub async fn check_and_maybe_erase(button: &mut Input<'_>, flash: &mut FlashStorage<'_>) {
